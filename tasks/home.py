...
# 只抓取原创微博
home_url = 'http://weibo.com/p/{}/home?&is_ori=1&is_tag=0&profile_ftype=1&page={}'
...
def crawl_weibo_datas(uid):
    ...
    while cur_page <= limit:
        ...
        ajax_url_0 = ajax_url.format(domain, 0, uid, cur_page, cur_page)
        ajax_url_1 = ajax_url.format(domain, 1, uid, cur_page, cur_page)
...
def excute_home_task():
    ...
    for uid in uids:
        app.send_task('tasks.home.crawl_weibo_datas', args=(uid[0],), queue='home_crawler',
