...
wbuser = Table("wbuser", metadata,
        ...
        Column("birthday", String(200), default=''),
        Column("location", String(100), default=''),
        Column("description", String(500), default=''),
        Column("register_time", String(200), default=''),
        Column("verify_type", INTEGER, default=0),
        Column("verify_info", String(300), default=''),
        Column("follows_num", INTEGER, default=0),
        Column("fans_num", INTEGER, default=0),
        Column("wb_num", INTEGER, default=0),
        Column("level", INTEGER, default=0),
        Column("tags", String(500), default=''),
        Column("work_info", String(500), default=''),
        Column("contact_info", String(300), default=''),
        Column("education_info", String(300), default=''),
        Column("head_img", String(500), default=''),
        )
...
seed_ids = Table('seed_ids', metadata,
        Column("id", INTEGER, primary_key=True, autoincrement=True),
        Column("uid", String(20), unique=True),
        Column("is_crawled", INTEGER, default=0),
        Column("other_crawled", INTEGER, default=0),
        Column("home_crawled", INTEGER, default=0),
        )
...
weibo_data = Table('weibo_data', metadata,
        ...
        Column("weibo_cont", String(6000), default=''),
        Column("repost_num", INTEGER, default=0),
        Column("comment_num", INTEGER, default=0),
        Column("praise_num", INTEGER, default=0),
        Column("uid", String(20)),
        Column("is_origin", INTEGER, default=1),
        Column("device", String(200), default=''),
